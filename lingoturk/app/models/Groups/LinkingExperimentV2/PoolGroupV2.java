                    ...
                    if (!(lhs_item.getH().equals("") || lhs_item.getH().equals("1"))) {
                        ...
                        for (Script rhs_script : getDescription()) {
                            if (rhs_script.getScriptId().equals(rhs_scriptId)) {
                                ...
                                return ok(views.html.renderExperiments.LinkingExperimentV1.LinkingExperimentV1_render.render(lhs_script, null, worker, assignmentId, hitId, turkSubmitTo, exp, df, "MTURK"));
                            }
                        }
                    }
                }
