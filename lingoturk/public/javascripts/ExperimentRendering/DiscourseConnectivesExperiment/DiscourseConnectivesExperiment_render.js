(function () {
    var app = angular.module('DiscourseConnectivesExperimentApp', ['Lingoturk']);

    app.controller('RenderController', ['$http', '$scope', '$timeout', function ($http, $scope, $timeout) {
        var self = this;
        self.state = "";
        self.allStates = [];
        self.questions = [];
        ...
        this.submitResults = function (successCallback, errorCallback) {
            var results = {
                experimentType : "DiscourseConnectivesExperiment",
